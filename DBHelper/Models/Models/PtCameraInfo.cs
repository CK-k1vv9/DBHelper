...
namespace Models
{
    ...
    public partial class PtCameraInfo
    {
        ...
        /// 点位编码
        /// </summary>
        [IsDBField("POSITION_CODE")]
        public string PositionCode { get; set; }

        /// <summary>
        /// (天网业务字段,与资产重复:所属点位ID）
        /// </summary>
        [IsDBField("POSITION_ID")]
        public string PositionId { get; set; }

        /// <summary>
        /// (天网业务字段,与资产重复:摄像头名称）
        /// </summary>
        [IsDBField("CAMERA_NAME")]
        ...
        /// </summary>
        [IsDBField("MONITOR_TYPE")]
        public string MonitorType { get; set; }

        /// <summary>
        /// 点位俗称
        /// </summary>
        [IsDBField("POINT_NAME")]
        public string PointName { get; set; }

        /// <summary>
        /// IPV6地址
        /// </summary>
        [IsDBField("CAMERA_IP6")]
        public string CameraIp6 { get; set; }

        /// <summary>
        /// 子网掩码
        /// </summary>
        [IsDBField("SUBNET_MASK")]
        ...
        /// </summary>
        [IsDBField("WATCH_SPEC_LOCATION")]
        public string WatchSpecLocation { get; set; }

        /// <summary>
        /// 所在道路位置：**路东、**路南、**路北、**路西
        /// </summary>
        [IsDBField("ROAD_DIRECTION")]
        ...
        /// </summary>
        [IsDBField("INDUSTRY_OWN")]
        public string IndustryOwn { get; set; }

        /// <summary>
        /// 是否已注册到汇聚平台
        /// </summary>
        [IsDBField("IS_REGISTER_IMOS")]
        ...
        /// 天网业务字段，描述
        /// </summary>
        [IsDBField("CAMERA_DESC")]
        public string CameraDesc { get; set; }

        /// <summary>
        /// 天网业务字段，是否已注册VCN
        /// </summary>
        [IsDBField("IS_REGISTER_VCN")]
